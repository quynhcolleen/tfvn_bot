...
ITEM_TYPE_CUSTOM_ROOM = "custom_room"
RENTAL_ITEM_TYPES = frozenset({ITEM_TYPE_CUSTOM_ROLE, ITEM_TYPE_CUSTOM_ROOM})
VALID_ITEM_TYPES = frozenset(
    {ITEM_TYPE_BADGE, ITEM_TYPE_ROLE, *RENTAL_ITEM_TYPES}
)
CUSTOM_ROLE_ITEM_ID = "custom_role"
CUSTOM_ROOM_ITEM_ID = "custom_room"
RESERVED_ITEM_IDS = frozenset({CUSTOM_ROLE_ITEM_ID, CUSTOM_ROOM_ITEM_ID})
ITEM_TYPE_ICONS = {
    ITEM_TYPE_ROLE: "🎭",
    ITEM_TYPE_BADGE: "🏷️",
...
ITEM_TYPE_LABELS = {
    ...
    ITEM_TYPE_CUSTOM_ROOM: "Custom room",
}
